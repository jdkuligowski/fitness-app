  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={({ route }) => {
        ...
        const isTabBarHidden = ['WorkoutDetails', 'TrainingDetails', 'CompleteWorkout', 'ChatOverview', 'VideoOverview', 'RunningSessionDetails', 'MobilitySessionDetails', 'CompleteRunningWorkout', 'CompleteMobilityWorkout', 'HiitSessionDetails'].includes(routeName);
