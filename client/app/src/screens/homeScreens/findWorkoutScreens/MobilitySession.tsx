...
export default function MobilityScreen() {
    ...
    const [selectedValue, setSelectedValue] = useState(5); // Default selected value
                    ...
                    <ScrollView contentContainerStyle={styles.scrollContainer}>
                        <View style={styles.header}>
                            <View style={styles.topSection}>
                                <View style={styles.leftSection}>
                                    ...
                                    <Text style={styles.workoutTitle}>Find a mobility session</Text>
                                </View>
                        ...
                        <View style={styles.workoutInfo}>
                            <View style={styles.workoutInfoDetails}>
                                <Text style={styles.workoutSubtitle}>What kind of mobility session do you want to do?</Text>
                                <View style={styles.workoutType}>
                                    {['Full body', 'Lower body', 'Upper body', 'Not sure'].map((option, index) => (
                                        <TouchableOpacity
                                            key={index}
                                            style={[
                                                styles.optionButton,
                            ...
                            {selectedWorkout ?
                                <View style={styles.buttonContainer}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() =>
                                            navigation.navigate("MobilitySessionDetails", {
